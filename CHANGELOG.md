...
### Changed
- Updated README to match Alfred Gallery submission
- Added auto-refresh documentation
- Added Bluetooth permissions setup step

## [1.0.1] - 2025-12-15

### Changed
- Extracted scripts to external file (`scripts/bluescope.js`) for better maintainability
- Added debug logging capability (disabled by default)
